...
const getBandColor = (band: string) => {
  if (band.includes("20–100"))
    return { bg: "bg-band-orange/[0.04]", text: "text-band-orange" };
  if (band.includes("0.1–5"))
    return { bg: "bg-band-green/[0.04]", text: "text-band-green" };
  if (band.includes("2.5–20"))
    return { bg: "bg-band-yellow/[0.04]", text: "text-band-yellow" };
  return { bg: "bg-gray-100", text: "text-gray-600" };
};

const getLevelColor = (level: string) => {
  if (level === "Enclave")
    return { bg: "bg-enclave-purple/[0.04]", text: "text-enclave-purple" };
  if (level === "Facility")
    return { bg: "bg-facility-magenta/[0.04]", text: "text-facility-magenta" };
  return { bg: "bg-gray-100", text: "text-gray-600" };
};
    ...
    <div className="flex flex-col items-center gap-8 w-full max-w-[1200px] mx-auto px-4 py-8 md:py-16">
      <div className="flex flex-col items-center gap-4 text-center">
        ...
        <p className="text-dark-text/[0.68] text-sm leading-5">
          Filter and search through certified strategic data centre facilities
          and enclaves
        </p>
      </div>
      ...
      <div className="flex flex-col lg:flex-row items-stretch lg:items-center gap-4 w-full">
        <div className="flex items-center gap-2 flex-1 px-4 py-4 rounded-2xl border border-brand-blue bg-brand-blue/[0.06]">
          <svg
            className="w-5 h-5 flex-shrink-0 fill-brand-blue"
            viewBox="0 0 16 16"
            fill="none"
          ...
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M2.16699 7.16663C2.16699 4.40913 4.40949 2.16663 7.16699 2.16663C9.92449 2.16663 12.167 4.40913 12.167 7.16663C12.167 9.92413 9.92449 12.1666 7.16699 12.1666C4.40949 12.1666 2.16699 9.92413 2.16699 7.16663ZM15.2558 14.0775L12.4267 11.2475C13.3042 10.1192 13.8333 8.705 13.8333 7.16667C13.8333 3.49083 10.8425 0.5 7.16667 0.5C3.49083 0.5 0.5 3.49083 0.5 7.16667C0.5 10.8425 3.49083 13.8333 7.16667 13.8333C8.705 13.8333 10.1192 13.3042 11.2475 12.4267L14.0775 15.2558C14.24 15.4183 14.4533 15.5 14.6667 15.5C14.88 15.5 15.0933 15.4183 15.2558 15.2558C15.5817 14.93 15.5817 14.4033 15.2558 14.0775Z"
            />
          </svg>
          <input
            type="text"
        ...
        <div className="flex flex-col sm:flex-row items-stretch gap-4">
          ...
          <button className="flex items-center justify-center gap-2 px-6 md:px-12 py-4 rounded-2xl bg-white shadow-[0_1px_1px_0_rgba(9,13,20,0.06),-4px_-4px_8px_0_rgba(255,255,255,0.40),8px_8px_24px_0_rgba(9,13,20,0.06)] hover:shadow-[0_2px_2px_0_rgba(9,13,20,0.08),-4px_-4px_8px_0_rgba(255,255,255,0.40),8px_8px_28px_0_rgba(9,13,20,0.08)] transition-shadow whitespace-nowrap">
            ...
            <span className="text-brand-blue text-sm font-medium leading-5 tracking-[-0.01em]">
              Export CSV
            </span>
          </button>
        </div>
      ...
      <div className="flex flex-col gap-6 w-full">
        <div className="flex flex-col gap-4 w-full rounded-3xl bg-white p-4 shadow-[0_1px_1px_0_rgba(9,13,20,0.06),-4px_-4px_8px_0_rgba(255,255,255,0.40),8px_8px_24px_0_rgba(9,13,20,0.06)]">
          <div className="hidden lg:grid grid-cols-[1fr_0.5fr_0.7fr_0.8fr_1.2fr_0.6fr_0.5fr_0.7fr_0.6fr] gap-4 px-4">
            ...
            <div className="text-dark-text/60 text-xs leading-4">
              ASX Ticker
            </div>
          </div>
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[1fr_0.5fr_0.7fr_0.8fr_1.2fr_0.6fr_0.5fr_0.7fr_0.6fr] gap-2 lg:gap-4 p-4 rounded-2xl bg-dark-text/[0.02] hover:bg-dark-text/[0.04] transition-colors">
      <div className="flex items-center lg:block">
        <span className="lg:hidden text-dark-text/60 text-xs mr-2 min-w-[80px]">
          Provider:
        </span>
        <a
          href="#"
          className="text-brand-blue text-xs leading-4 hover:underline"
        >
          {facility.provider}
        </a>
      </div>
      ...
      <div className="flex items-center lg:block">
        ...
        <span className="text-dark-text text-xs leading-4">
          {facility.site}
        </span>
      </div>
      ...
      <div className="flex items-center lg:block">
        ...
        <span
          className={`inline-flex px-2 py-2 rounded-xl ${levelColors.bg} ${levelColors.text} text-xs font-medium leading-4`}
        >
          {facility.level}
        </span>
      </div>
      ...
      <div className="flex items-center lg:block">
        ...
        <span
          className={`inline-flex px-2 py-2 rounded-xl ${bandColors.bg} ${bandColors.text} text-xs font-medium leading-4`}
        >
          {facility.band}
        </span>
      </div>
